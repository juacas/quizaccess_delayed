...
/**
 * Restore code for the quizaccess_activatedelayedattempt plugin.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_quizaccess_activatedelayedattempt_subplugin extends restore_mod_quiz_access_subplugin {
    ...
    protected function define_quiz_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/quizaccess_activatedelayedattempt');
    ...
    /**
     * Processes the quizaccess_activatedelayedattempt element, if it is in the file.
     * @param array $data the data read from the XML file.
     */
    public function process_quizaccess_activatedelayedattempt($data) {
        global $DB;

        $data = (object)$data;
        $data->quizid = $this->get_new_parentid('quiz');
        $DB->insert_record('quizaccess_delayedattempt', $data);
    }
}
